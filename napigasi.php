...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true"></i> MTSDM</a></h1>
			...
			else
			{
				...
				echo "
						...
						<ul class='agile_forms'>
							...
							<table class='table'>
								...
								<tr>
									<td><a class='dropdown-item' href='Admin/input_pembayaran.php'>Administrasi</a></td>
								</tr>
				...
				echo "
						...
						<ul class='agile_forms'>
							...
							<table class='table'>
								<tr>
									<td><a class='dropdown-item' href='Murid'>Cek Pembayaran</a></td>
								</tr>
			...
			<header>
				<nav class="link-effect-2" id="desktop-nav">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index.php" class="page-scroll">Beranda</a></li>
						<li><a href="#fasilitas" class="page-scroll">Fasilitas </a></li>
						<li><a href="#profile_sekolah" class="page-scroll">Profil Sekolah</a></li>
						<li><a href="#mail" class="page-scroll">Contact</a></li>
					</ul>
				</nav>
			</header>
			</div>
