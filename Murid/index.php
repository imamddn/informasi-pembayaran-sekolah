...
$tampil="SELECT * FROM administrasi WHERE nama_murid = '$Nama_Murid'";
$hasil=mysql_query($tampil);
$data=mysql_fetch_array($hasil);

$Jumlah_Pengurangan_Dasi = $data['dasi'] - 25000 ;
...
$Jumlah_Pengurangan_Kerudung = $data['kerudung'] - 75000 ;
...
$Jumlah_Pengurangan_LKS1 = $data['lks_smt_1'] - 105000;
...
$Jumlah_Pengurangan_UTS1 = $data['uts_smt_1'] - 15000;
...
$Jumlah_Pengurangan_PAS1 = $data['pas_smt_1'] - 25000;
...
$Jumlah_Pengurangan_LKS2 = $data['lks_smt_2'] - 105000;
...
$Jumlah_Pengurangan_UTS2 = $data['uts_smt_2'] - 15000;
...
$Jumlah_Pengurangan_PAS2 = $data['pas_smt_2'] - 25000;
...
$Jumlah_Pengurangan_Infaq = $data['infaq_12_bulan'] - 120000;
...
$tanggal = $datatanggal['id_transaksi']
...
<tbody>
  <tr>
    ...
    <td class='tg-ycr8'> $datatanggal[tanggal]</td>
    <td class='tg-ycr8'> Rp $data[dasi] </td>
  ...
  <tr>
    ...
    <td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[kerudung] </td>
  ...
  <tr>
	...
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[lks_smt_1] </td>
  ...
  <tr>
	...
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[uts_smt_1] </td>
  ...
  <tr>
    ...
    <td class='tg-ycr8'>Rp. 25.000</td>
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[pas_smt_1] </td>
  ...
  <tr>
    ...
    <td class='tg-ycr8'>Rp. 105.000</td>
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[lks_smt_2] </td>
  ...
  <tr>
    ...
    <td class='tg-ycr8'>Rp. 15.000</td>
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[uts_smt_2] </td>
  ...
  <tr>
    ...
    <td class='tg-ycr8'>Rp. 25.000</td>
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'> Rp $data[pas_smt_2] </td>
  ...
  <tr>
	...
	<td class='tg-ycr8'> $datatanggal[tanggal] </td>
    <td class='tg-ycr8'>  Rp $data[infaq_12_bulan]  </td>
