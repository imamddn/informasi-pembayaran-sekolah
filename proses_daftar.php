...
if(mysql_num_rows($sql) == 0)
{
	...
	$input_murid="INSERT INTO `murid` (`nisn`, `nama_murid`, `kota`, `jenkel`, `agama`, `kelas`) VALUES ('$_POST[Nisn]', '$_POST[Nama_Murid]', '$_POST[Kota]', '$_POST[Jenis_Kelamin]', '$_POST[Agama]', '$_POST[Kelas]');";
